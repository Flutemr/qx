...
import com.ibeifeng.offline.data.analysis.platform.dimension.operation.DimensionOperatorImpl;
import com.ibeifeng.offline.data.analysis.platform.dimension.operation.IDimensionOperator;
import com.ibeifeng.offline.data.analysis.platform.util.JdbcManager;
...
public class TransformerOutputFormat extends OutputFormat<BaseDimension, BaseStatsValueWritable> {
    ...
    public RecordWriter<BaseDimension, BaseStatsValueWritable> getRecordWriter(TaskAttemptContext context) throws IOException, InterruptedException {
        ...
        IDimensionOperator converter = new DimensionOperatorImpl();
        try {
    ...
    public class TransformerRecordWriter extends RecordWriter<BaseDimension, BaseStatsValueWritable> {
        ...
        private IDimensionOperator converter = null;
        ...
        public TransformerRecordWriter(Connection conn, Configuration conf, IDimensionOperator converter) {
            super();
            this.conn = conn;
            this.conf = conf;
