package com.ibeifeng.offline.data.analysis.platform.util;
...
import com.ibeifeng.offline.data.analysis.platform.util.UserAgentUtil.UserAgentInfo;
...
public class LoggerUtil {
    ...
    private static void handleIp(Map<String,String> clientInfo) {
        if (clientInfo.containsKey(EventLogConstants.LOG_COLUMN_NAME_IP)) {
            ...
            RegionInfo info = ipSeekerExt.analyseIp(ip);
            if (info != null) {
