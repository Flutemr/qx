package com.ibeifeng.offline.data.analysis.platform.dimension.stats;
...
public class StatsUserDimension extends StatsDimension {
    ...
    public static StatsUserDimension clone(StatsUserDimension dimension) {
        BrowserDimension browser = new BrowserDimension(dimension.browser.getBrowser(), dimension.browser.getBrowserVersion());
